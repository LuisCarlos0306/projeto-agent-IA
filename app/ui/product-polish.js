(() => {
  ...
  function installDatastoreMonitorAssets() {
    if (!document.querySelector('link[data-datastore-monitor]')) {
      const stylesheet = document.createElement("link");
      stylesheet.rel = "stylesheet";
      stylesheet.href = "/ui/assets/datastore-monitor.css?v=1.30.13";
      stylesheet.dataset.datastoreMonitor = "1";
      document.head.append(stylesheet);
    }
    import("/ui/assets/datastore-monitor.js?v=1.30.13").catch((error) => {
